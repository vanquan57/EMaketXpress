    ...
    <div class="w-screen h-screen bg-no-repeat bg-center bg-cover flex items-center"
        ...
        <div
            ...
            <form action="" method="POST">
                <h3 class="text-[26px] text-[#222] font-medium">Đăng nhập</h3>
                ...
                <a href="/forget-password" class="mt-5 inline-block text-[14px] text-[#306BD9]">Quên mật khẩu ?</a>
                <button type="submit"
            ...
            <div class="text-[14px] text-center">Chưa có tài khoản? <a
                    class="mt-5 inline-block font-semibold text-[#306BD9]" href="/register">Đăng ký tài khoản mới</a>
            </div>
        </div>
    </div>
    <script>
