        ...
        <form action="" method="POST" class="p-4 ">
            <div class="mb-4 flex">
                <div class=" flex flex-col  flex-1">
                    ...
                    <input type="text" id="slider_name" name="slider_name" placeholder="Tiêu Đề"
                ...
                <div class=" flex flex-col flex-1 ml-10"> 
                    ...
                    <input type="text" id="slider_url " name="slider_url" placeholder="Đường dẫn"
                        class=" mt-2 border border-gray-400 p-2 rounded-md outline-none focus:border-blue-500">
                        @if (Session::has('errors'))
                            <div class="transition-all errors_Email text-[12px] text-[#FF0000]">
            ...
            <div class="mb-4 flex flex-col ">
                ...
                <input type="text" id="slider_sort_by " name="slider_sort_by" placeholder="Xắp xếp" value="1"
                    class=" mt-2 border border-gray-400 p-2 rounded-md outline-none focus:border-blue-500">
            </div>
            <div  class="mb-4 flex flex-col ">
            ...
            <div class="flex items-center mb-4">
                <input checked id="default-radio-1" type="radio" value="1" name="active"
            ...
            <div class="flex items-center">
                <input id="default-radio-2" type="radio" value="0" name="active"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
