        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-5">
                    ...
                    <div id="controls-carousel" class="relative w-full" data-carousel="static">
                        ...
                        <button type="button"
                            ...
                            <span
                                ...
                                <svg class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180 text-blue-900"
            ...
            <div class="lg:col-span-4 col-span-1">
                ...
                <div class="mt-2">
                    {{-- productDetail --}}
                    <span
                        class="font-semibold text-2xl text-[#CD151C]">{{ number_format($productDetail->Price, 0, ',', '.') . 'đ' }}</span>
                    <span
                        class="text-lg font-medium text-[#D1D3D3]"><s>{{ number_format($productDetail->Price_sale, 0, ',', '.') . 'đ' }}</s></span>
                </div>
                <div class="mt-2">
                    {{-- (($productDetail->Price - $productDetail->Price_sale)/$productDetail->Price)*100; --}}
                    <span class="text-sm font-normal pr-1 ">Tiết kiệm:
                        {{ number_format($productDetail->Price - $productDetail->Price_sale, 0, ',', '.') . 'đ' }}</span>
                    <span
                        class="font-medium text-base py-1 px-2 bg-[#FCAF17] rounded-md">{{ number_format((($productDetail->Price - $productDetail->Price_sale) / $productDetail->Price) * 100) }}%</span>
                </div>
                ...
                <div class="flex flex-wrap group_type_color">
                    @for ($i = 0; $i < $ParentId_img->count(); $i++)
                        <img type-color ="{{ $ParentId_img[$i]->Color }}"
                            class="w-[50px] h-[70px] inline-block object-cover rounded-lg m-1"
                            src=" /storage/uploads/{{ $ParentId_img[$i]->Img }}" alt="">
                    @endfor
            ...
            <div class="grid lg:grid-cols-12 grid-cols-1 gap-3">
                <div class="lg:col-span-3 grid lg:grid-cols-1   lg:block ">
                    <div class="col-span-1 p-2 flex justify-center">
                        <div class="mr-20">
                            <p class="text-4xl">4.4<span class="text-2xl">/5<i
                                        class="fa-solid fa-star text-yellow-200"></i></span></p>
                ...
                <div class="lg:col-span-6 grid lg:grid-cols-1  lg:block">
                    @if ($checkPurchaseOrder == 1 || $checkAdmin?->role == 1)
                        <div>
                            ...
                            <div class="flex">
                                <button id="1" style="border:none;background-color:white;color:rgb(202, 202, 191)"
                                    onclick="Star(1)"><i class="fa-solid fa-star"></i></button>
                                <button id="2"style="border:none;background-color:white;color:rgb(202, 202, 191)"
                                    onclick="Star(2)"><i class="fa-solid fa-star"></i></button>
                                <button id="3"style="border:none;background-color:white;color:rgb(202, 202, 191)"
                                    onclick="Star(3)"><i class="fa-solid fa-star"></i></button>
                                <button id="4"style="border:none;background-color:white;color:rgb(202, 202, 191)"
                                    onclick="Star(4)"><i class="fa-solid fa-star"></i></button>
                                <button id="5"style="border:none;background-color:white;color:rgb(202, 202, 191)"
                                    onclick="Star(5)"><i class="fa-solid fa-star"></i></button>
                            </div>
                    ...
                    @else
                        <div>
                            ...
                            <div class="flex">
                                <button id="1"
                                    style="border:none;background-color:white;color:rgb(202, 202, 191)"><i
                                        class="fa-solid fa-star"></i></button>
                                <button
                                    id="2"style="border:none;background-color:white;color:rgb(202, 202, 191)"><i
                                        class="fa-solid fa-star"></i></button>
                                <button
                                    id="3"style="border:none;background-color:white;color:rgb(202, 202, 191)"><i
                                        class="fa-solid fa-star"></i></button>
                                <button
                                    id="4"style="border:none;background-color:white;color:rgb(202, 202, 191)"><i
                                        class="fa-solid fa-star"></i></button>
                                <button
                                    id="5"style="border:none;background-color:white;color:rgb(202, 202, 191)"><i
                                        class="fa-solid fa-star"></i></button>
                            </div>
        ...
        @for ($i = 0; $i < $comment->count(); $i++)
            <div id="{{ $i }}">
                ...
                <div class="flex  justify-between ">
                    <div class="">
                        <div class="flex text-xs">
                            <button id="reviews_{{ $comment[$i]->ID_comment . '1' }}"
                                style="border:none;background-color:white;color:rgb(202, 202, 191)"><i
                                    class="fa-solid fa-star"></i></button>
                            <button id="reviews_{{ $comment[$i]->ID_comment . '2' }}"
                                style="border:none;background-color:white;color:rgb(202, 202, 191)"><i
                                    class="fa-solid fa-star"></i></button>
                            <button id="reviews_{{ $comment[$i]->ID_comment . '3' }}"
                                style="border:none;background-color:white;color:rgb(202, 202, 191)"><i
                                    class="fa-solid fa-star"></i></button>
                            <button id="reviews_{{ $comment[$i]->ID_comment . '4' }}"
                                style="border:none;background-color:white;color:rgb(202, 202, 191)"><i
                                    class="fa-solid fa-star"></i></button>
                            <button id="reviews_{{ $comment[$i]->ID_comment . '5' }}"
                                style="border:none;background-color:white;color:rgb(202, 202, 191)"><i
                                    class="fa-solid fa-star"></i></button>
                        </div>
                    </div>
                ...
                <div class="flex ">
                    ...
                    @else
                        <img class="h-10 w-10"
                            src="https://bizweb.dktcdn.net/100/438/408/themes/931909/assets/account_ava.jpg?1701143626189"
                            alt="">
                    @endif
            ...
            @for ($i = 0; $i < $listProductSale->count(); $i++)
                <div class="col-span-1 my-5 group_Product ">
                    <a href="{{ $listProductSale[$i]->Slug }}" class="inline-block overflow-hidden relative rounded">
                        <img src="/storage/uploads/{{ $listProductSale[$i]->Img }}" alt=""
                    ...
                    <div>
                        ...
                        <div class="py-1">
                            <span
                                class="font-medium text-[#CD151C]">{{ number_format($listProductSale[$i]->Price_sale, 0, ',', '.') . 'đ' }}</span>
                            <span
                                class="font-medium text-[#8A8A8F]"><s>{{ number_format($listProductSale[$i]->Price_sale, 0, ',', '.') . 'đ' }}</s></span>
                        </div>
                    </div>
                            ...
                            @if ($listProductSale[$i]->ProductID == $imagesSale[$j]->ProductID)
                                <li
                                    ...
                                    <img class="h-[100%] w-[100%] object-cover rounded-full"
                                        src=" /storage/uploads/{{ $imagesSale[$j]->Img }}" alt="">
                                </li>
                            @endif
                        @endfor
                    </ul>
